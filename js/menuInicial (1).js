...
export default class menuInicial extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('paleta1', 'paleta1.jpg');
        this.load.image('paleta2', 'paleta2.jpg');
        this.load.image('paleta3', 'paleta3.jpg');
        this.load.image('paleta4', 'paleta4.jpg');
        this.load.image('paleta5', 'paleta5.jpg');
        this.load.image('paleta6', 'paleta6.jpg');
    }
